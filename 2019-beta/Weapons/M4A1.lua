...
function weaponData.getStats()
	return {
		...
		recoilXDampDur     = 10,
		recoilXDampExp     = 1.05,
		recoilXDampInit    = 0.85,
		recoilXRec         = 7.8,
		recoilYMult        = 1,
		recoilYPattern     = "3,-1.5,3;10,2,3;20,1,5",
		recoilYRan         = 0.2,
		recoilYRec         = 2.44,
		recoilYStart       = 3,
		recoilZ            = 0.25 * 0.75,
		recoilZBackDur     = 0.1,
		recoilZReturnDur   = 0.27,
		rps                = 11.67,
		spread             = 11,
		weight             = 0.985,
		supportedFireModes = {
...
local function getFppPoses()
	...
	holding = {
		FppLeftArm = newCf(-0.7934, -0.3124, -1.2806, 0.8139, 0.1806, -0.5523, -0.4664, 0.7700, -0.4354, 0.3466, 0.6119, 0.7109),
		FppRightArm = newCf(0.4211, 0.3056, 0.2160, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000),
	},
	sprinting = {
...
function weaponData.getDefaultAttachments()
	return {
		Magazine = "stanagmag",
		Handle   = "colt_grip",
		Muzzle   = "m4a1_stdmuzzle",
		Stock    = "m4a1_stdstock",
		Optic    = "m4a1_carryhandle",
		Barrel   = "m4a1_stdbarrel",
	}
end
