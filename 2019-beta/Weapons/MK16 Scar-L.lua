...
function weaponData.getStats()
	return {
		...
		recoilXRec       = 7.75,
		recoilYMult      = 1.05,
		recoilYPattern   = "2,1.3,2;6,1.85,4;13,-1.5,4;22,-0.2,5",
		recoilYRan       = 0.25,
		recoilYRec       = 2.2,
		recoilYStart     = 4,
		recoilZ          = 0.27 * 0.6,
		recoilZBackDur   = 0.1,
		recoilZReturnDur = 0.3,
		rps              = 10.42,
		spread           = 10.7,
		weight           = 1.02,
		supportedFireModes = {
...
local function getFppPoses()
	return {
		...
		holding = {
			FppLeftArm = newCf(-0.7584, -0.4165, -1.2806, 0.8139, 0.1806, -0.5523, -0.4664, 0.7700, -0.4354, 0.3466, 0.6119, 0.7109),
			FppRightArm = newCf(0.4211, 0.1931, 0.2160, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000),
		},
		sprinting = {
...
function weaponData.getAniData()
	...
	return {
		...
		aniparts = {
			...
			WeaponBolt = "mk16_main.mk16_bolt",
			ShellP0    = "f.ShellP0",
			ShellD0    = "f.ShellD0",
...
function weaponData.getDefaultAttachments()
	return {
		Magazine = "stanagmag",
		Handle   = "colt_grip",
		Muzzle   = "mk16_stdmuzzle",
		Stock    = "mk16_stockext",
		Barrel   = 'mk16_stdbarrel',
	}
end
...
function weaponData.getDefaultSight()
	return {
		lowered = "mk16_main.mk16_ironsights_lowerd",
		raised  = "mk16_main.mk16_ironsights_raised",
	}
end
