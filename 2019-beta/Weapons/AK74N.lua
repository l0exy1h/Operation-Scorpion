...
function weaponData.getStats()
	return {
		...
		recoilXRec         = 8.5,
		recoilYMult        = 1.2,
		recoilYPattern     = "3,0.88,2;8,-0.99,4;17,0.55",
		recoilYRan         = 0.33,
		recoilYRec         = 1.02,
		recoilYStart       = 3,
		recoilZ            = 0.34,
...
local function getfppPoses() 
	return {
		...
		holding = {
			FppLeftArm = newCf(-0.7514, -0.3124, -1.5041, 0.8139, 0.1806, -0.5523, -0.4664, 0.7700, -0.4354, 0.3466, 0.6119, 0.7109),
			FppRightArm = newCf(0.4205, 0.3238, 0.1807, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000),
		},
		sprinting = {
...
function weaponData.getAniData()
	...
	return {
		...
		aniparts = {
			WeaponMain = "primary",
			WeaponMag  = "ak74_stdmag.ak74_stdmag",
			WeaponBolt = "f.ak74_bolt",
			ShellP0    = "f.ShellP0",
			ShellD0    = "f.ShellD0",
		...
		sounds = sounds,
		shell = script["762x39_casing"],
	}
end

function weaponData.getDefaultAttachments()
	return {
		Magazine = "ak74_stdmag",
		Handle   = "ak74_stdgrip",
		Muzzle   = "ak74_stdmuzzle",
		Stock    = "ak74_stdstock",
		Barrel   = "ak74_stdhandguard",
	}
end
...
function weaponData.getCompatibleAttachments()
	return {
		Barrel = {
			["AK74N Tactical Handguard"] = 1,
		},
		-- Handle = {},
		Mount = {
			["AK74N Tactical Mount"] = 1
		},
		Muzzle = {
			["KA Mams"] = 1,
			["M4SD Compensator"] = 1,
